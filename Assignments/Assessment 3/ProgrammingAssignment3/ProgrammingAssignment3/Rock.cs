    ...
    public class Rock
    {
        ...
        public void Update(GameTime gameTime)
        {
            ...
            if (!OutsideWindow)
            {
                ...
                //if (drawRectangle.X < 0 || drawRectangle.X + drawRectangle.Width > windowWidth || drawRectangle.Y < 0 || drawRectangle.Y + drawRectangle.Height > windowHeight)
                ...
                // elegant: outsideWindow = drawRectangle.Left > windowWidth || drawRectangle.Right < 0 || drawRectangle.Top > windowHeight || drawRectangle.Bottom < 0;
            }
