...
namespace ProgrammingAssignment2
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        Texture2D sprite1, sprite2, sprite3;
        ...
        protected override void LoadContent()
        {
            ...
            sprite1 = Content.Load<Texture2D>("image1");
            sprite2 = Content.Load<Texture2D>("image2");
            sprite3 = Content.Load<Texture2D>("image3");
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            drawRectangle.Offset(speed_x, speed_y);
