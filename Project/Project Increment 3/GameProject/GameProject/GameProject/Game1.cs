        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            for (int i = 0; i < bears.Count - 1; i++)
            {
                for (int j = i + 1; j < bears.Count; j++)
                {
                    ...
                    {
                        CollisionResolutionInfo Info = CollisionUtils.CheckCollision(gameTime.ElapsedGameTime.Milliseconds, GameConstants.WINDOW_WIDTH, GameConstants.WINDOW_HEIGHT,
